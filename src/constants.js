...
export const CLASS_PROFILE_CONTAINER = 'ba-profile-container';
export const SELECTOR_PROFILE_CONTAINER = `.${CLASS_PROFILE_CONTAINER}`;
export const CLASS_PROFILE_IMG_CONTAINER = 'ba-profile-image-container';
export const SELECTOR_PROFILE_IMG_CONTAINER = `.${CLASS_PROFILE_IMG_CONTAINER}`;
export const CLASS_USER_NAME = 'ba-user-name';
export const SELECTOR_USER_NAME = `.${CLASS_USER_NAME}`;
export const CLASS_CREATED_DATE = 'ba-created-date';
export const SELECTOR_CREATED_DATE = `.${CLASS_CREATED_DATE}`;

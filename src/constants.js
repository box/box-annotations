...
export const CLASS_ANNOTATION_BUTTON_POINT_EXIT = 'bp-btn-annotate-point-exit';
...
export const CLASS_ANNOTATION_COMMENT_TEXT = 'bp-annotation-comment-text';
...
export const CLASS_ANNOTATION_MODE_HEADER = 'bp-annotate-mode-header';
export const CLASS_ANNNOTATION_MODE_BACKGROUND = 'bp-annotate-mode-background';

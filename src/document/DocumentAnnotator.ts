...
import { centerRegion, isRegion, RegionCreationManager, RegionListManager } from '../region';
...
export default class DocumentAnnotator extends BaseAnnotator {
    ...
    getPageManagers(pageEl: HTMLElement): Set<BaseManager> {
        ...
        if (managers.size === 0) {
            ...
            managers.add(new RegionListManager({ location: pageNumber, referenceEl: pageReferenceEl }));

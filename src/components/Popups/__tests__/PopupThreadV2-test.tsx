...
import PopupThreadV2, { Props } from '../PopupThreadV2';
...
jest.mock('../../../store/annotations/actions', () => ({
    ...
    updateAnnotationAction: jest.fn(),
}));
...
describe('PopupThreadV2', () => {
    ...
    test('should render ThreadedAnnotationsV2 inside FocusTrap with MentionContextProvider', () => {
        render(<PopupThreadV2 {...defaults} />);
    ...
    test('should render with isAnnotations=true', () => {
        ...
        expect(screen.getByTestId('threaded-annotations-v2').getAttribute('data-is-annotations')).toBe('true');
    });

    test('should render messages from annotation', () => {
        render(<PopupThreadV2 {...defaults} />);

        expect(screen.getByTestId('threaded-annotations-v2').getAttribute('data-messages-count')).toBe('1');
    });

    test('should render with empty messages when annotation is not found', () => {
    ...
    test('should pass all action callbacks to ThreadedAnnotationsV2', () => {
        ...
        expect(thread.getAttribute('data-has-on-delete')).toBe('true');

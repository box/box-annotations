...
- feat(eventing): set active annotation id (#427) ([e52eacb](https://github.com/box/box-annotations/commit/e52eacb)), closes [#427](https://github.com/box/box-annotations/issues/427)
- feat(events): Add eventing middleware (#419) ([8fdad53](https://github.com/box/box-annotations/commit/8fdad53)), closes [#419](https://github.com/box/box-annotations/issues/419)
- feat(header): Remove header buttons (#404) ([c4b4a40](https://github.com/box/box-annotations/commit/c4b4a40)), closes [#404](https://github.com/box/box-annotations/issues/404)
- feat(region): Add annotation popup components and tests (#412) ([673684f](https://github.com/box/box-annotations/commit/673684f)), closes [#412](https://github.com/box/box-annotations/issues/412)
- feat(region): Add custom cursor (#424) ([d5592a8](https://github.com/box/box-annotations/commit/d5592a8)), closes [#424](https://github.com/box/box-annotations/issues/424)
- feat(region): Add document annotator and region manager scaffolding (#402) ([c1dbb06](https://github.com/box/box-annotations/commit/c1dbb06)), closes [#402](https://github.com/box/box-annotations/issues/402)
- feat(region): Add popup component stylesheets (#414) ([40b130d](https://github.com/box/box-annotations/commit/40b130d)), closes [#414](https://github.com/box/box-annotations/issues/414)
- feat(region): Add region creator components and container (#409) ([d7edf6b](https://github.com/box/box-annotations/commit/d7edf6b)), closes [#409](https://github.com/box/box-annotations/issues/409)
- feat(region): Add region manager logic and renderers (#406) ([4772d26](https://github.com/box/box-annotations/commit/4772d26)), closes [#406](https://github.com/box/box-annotations/issues/406)
- feat(region): Connect region components to store (#416) ([e4d8588](https://github.com/box/box-annotations/commit/e4d8588)), closes [#416](https://github.com/box/box-annotations/issues/416)
- feat(region): Improve annotation create action async flow (#421) ([f55e217](https://github.com/box/box-annotations/commit/f55e217)), closes [#421](https://github.com/box/box-annotations/issues/421)
- feat(rewrite): Remove all code related to mobile-specific ui (#398) ([2a2cd8b](https://github.com/box/box-annotations/commit/2a2cd8b)), closes [#398](https://github.com/box/box-annotations/issues/398)
- feat(store): Add redux store with toggleAnnotationMode (#407) ([f2cd727](https://github.com/box/box-annotations/commit/f2cd727)), closes [#407](https://github.com/box/box-annotations/issues/407)
- feat(store): Add toggleAnnotationVisibility (#415) ([b545f09](https://github.com/box/box-annotations/commit/b545f09)), closes [#415](https://github.com/box/box-annotations/issues/415)
- feat(store): Change toggle to setVisibility (#418) ([1336117](https://github.com/box/box-annotations/commit/1336117)), closes [#418](https://github.com/box/box-annotations/issues/418)
- test(eventing): Adding tests for eventing (#426) ([4ccc542](https://github.com/box/box-annotations/commit/4ccc542)), closes [#426](https://github.com/box/box-annotations/issues/426)
- chore: disable e2e tests (#410) ([2b46c26](https://github.com/box/box-annotations/commit/2b46c26)), closes [#410](https://github.com/box/box-annotations/issues/410)
- chore: inline sourcemaps when linked (#403) ([7dd55eb](https://github.com/box/box-annotations/commit/7dd55eb)), closes [#403](https://github.com/box/box-annotations/issues/403)
- chore(codeowners): Update codeowners to reflect new groups (#393) ([8dddad8](https://github.com/box/box-annotations/commit/8dddad8)), closes [#393](https://github.com/box/box-annotations/issues/393)
- chore(deps): Upgrade all relevant production dependencies (#420) ([ca69741](https://github.com/box/box-annotations/commit/ca69741)), closes [#420](https://github.com/box/box-annotations/issues/420)
- chore(deps): Upgrade node and yarn version requirements (#391) ([2bf73b9](https://github.com/box/box-annotations/commit/2bf73b9)), closes [#391](https://github.com/box/box-annotations/issues/391)
- chore(deps): Upgrade preview and production dependencies (#385) ([6102a0d](https://github.com/box/box-annotations/commit/6102a0d)), closes [#385](https://github.com/box/box-annotations/issues/385)
- chore(examples): Remove unused styleguidist examples and dependencies (#388) ([f0a3379](https://github.com/box/box-annotations/commit/f0a3379)), closes [#388](https://github.com/box/box-annotations/issues/388)
- chore(functional-tests): remove selenium/codecept functional tests (#400) ([7096d06](https://github.com/box/box-annotations/commit/7096d06)), closes [#400](https://github.com/box/box-annotations/issues/400)
- chore(i18n): Remove Internationalize and add cache (#397) ([ef6e0f1](https://github.com/box/box-annotations/commit/ef6e0f1)), closes [#397](https://github.com/box/box-annotations/issues/397)
- chore(i18n): update translations (#382) ([da74571](https://github.com/box/box-annotations/commit/da74571)), closes [#382](https://github.com/box/box-annotations/issues/382)
- chore(i18n): update translations (#394) ([ea259ae](https://github.com/box/box-annotations/commit/ea259ae)), closes [#394](https://github.com/box/box-annotations/issues/394)
- chore(i18n): update translations (#405) ([0c51399](https://github.com/box/box-annotations/commit/0c51399)), closes [#405](https://github.com/box/box-annotations/issues/405)
- chore(i18n): update translations (#413) ([1f74951](https://github.com/box/box-annotations/commit/1f74951)), closes [#413](https://github.com/box/box-annotations/issues/413)
- chore(i18n): update translations (#417) ([b43c5a4](https://github.com/box/box-annotations/commit/b43c5a4)), closes [#417](https://github.com/box/box-annotations/issues/417)
- chore(i18n): Upgrade react-intl to 3.x (#396) ([da36b29](https://github.com/box/box-annotations/commit/da36b29)), closes [#396](https://github.com/box/box-annotations/issues/396)
- chore(mergify): Add mergify.yml for mergify support (#395) ([1d62855](https://github.com/box/box-annotations/commit/1d62855)), closes [#395](https://github.com/box/box-annotations/issues/395)
- chore(scripts): Clean up remaining scripts, tests, and config files (#389) ([6585209](https://github.com/box/box-annotations/commit/6585209)), closes [#389](https://github.com/box/box-annotations/issues/389)
- chore(store): add redux store unit tests (#411) ([a4659f6](https://github.com/box/box-annotations/commit/a4659f6)), closes [#411](https://github.com/box/box-annotations/issues/411)
- chore(typescript): Add support for typescript (#399) ([9384e60](https://github.com/box/box-annotations/commit/9384e60)), closes [#399](https://github.com/box/box-annotations/issues/399)
- chore(typescript): Enable automatic type checking for VS Code (#425) ([fed9ba1](https://github.com/box/box-annotations/commit/fed9ba1)), closes [#425](https://github.com/box/box-annotations/issues/425)
- docs(license): Update license to Box CLA (#408) ([6113fa0](https://github.com/box/box-annotations/commit/6113fa0)), closes [#408](https://github.com/box/box-annotations/issues/408)
- refactor(buie): Migrate from box-react-ui to box-ui-elements (#387) ([a98f276](https://github.com/box/box-annotations/commit/a98f276)), closes [#387](https://github.com/box/box-annotations/issues/387)
- refactor(i18n): Add 18n support without Preview (#392) ([d59f278](https://github.com/box/box-annotations/commit/d59f278)), closes [#392](https://github.com/box/box-annotations/issues/392)
- refactor(typescript): Migrate entrypoint module to typescript (#401) ([76bd0f1](https://github.com/box/box-annotations/commit/76bd0f1)), closes [#401](https://github.com/box/box-annotations/issues/401)
- fix(docs): Revert annotation asset paths used by example site (#390) ([98d8a32](https://github.com/box/box-annotations/commit/98d8a32)), closes [#390](https://github.com/box/box-annotations/issues/390)
- build(deps): Add @box/frontend and upgrade dependencies (#380) ([286e9ca](https://github.com/box/box-annotations/commit/286e9ca)), closes [#380](https://github.com/box/box-annotations/issues/380)
- build(deps): Update babel and jest to latest versions (#383) ([2af9244](https://github.com/box/box-annotations/commit/2af9244)), closes [#383](https://github.com/box/box-annotations/issues/383)
- build(deps): Upgrade and separate dev dependencies (#384) ([b49e6dd](https://github.com/box/box-annotations/commit/b49e6dd)), closes [#384](https://github.com/box/box-annotations/issues/384)
- build(hooks): Remove unnecessary steps from prepush script (#386) ([2f6928a](https://github.com/box/box-annotations/commit/2f6928a)), closes [#386](https://github.com/box/box-annotations/issues/386)
- Docs: Add comment around cypress auth ([bf2f50c](https://github.com/box/box-annotations/commit/bf2f50c))
- Chore: Update script names to latest conventions (#365) ([6e23ddf](https://github.com/box/box-annotations/commit/6e23ddf)), closes [#365](https://github.com/box/box-annotations/issues/365)
- Chore: Upgrade preview version in test/doc files (#362) ([a034d3d](https://github.com/box/box-annotations/commit/a034d3d)), closes [#362](https://github.com/box/box-annotations/issues/362)
- Chore: Adding support for cypress testing ([9efe675](https://github.com/box/box-annotations/commit/9efe675))

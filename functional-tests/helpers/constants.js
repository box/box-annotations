...
const CLASS_PROFILE_CONTAINER = 'ba-profile-container';
exports.SELECTOR_PROFILE_CONTAINER = `.${CLASS_PROFILE_CONTAINER}`;
const CLASS_PROFILE_IMG_CONTAINER = 'ba-profile-image-container';
exports.SELECTOR_PROFILE_IMG_CONTAINER = `.${CLASS_PROFILE_IMG_CONTAINER}`;
const CLASS_USER_NAME = 'ba-user-name';
exports.SELECTOR_USER_NAME = `.${CLASS_USER_NAME}`;
const CLASS_CREATED_DATE = 'ba-created-date';
exports.SELECTOR_CREATED_DATE = `.${CLASS_CREATED_DATE}`;
